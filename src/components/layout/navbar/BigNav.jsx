                    ...
                    <div className="hidden md:block pr-5">
                        <nav className="flex gap-8 text-sm">
                            ...
                            <div className="group relative">
                                ...
                                <div className="absolute top-full -left-28 -translate-x-1/2 w-3xl opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none group-hover:pointer-events-auto">
